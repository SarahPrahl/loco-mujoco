...
class UnitreeG1Ball29(BaseRobotHumanoid):

    """
    Description
    ------------

    Mujoco environment of the Unitree G1 robot with 29 dof.
    ...
    ------------ ----------------------------- ---------------- ------------------------------------ ------------------------------ ---
    29           q_right_shoulder_pitch_joint  JointPos         -3.0892                              2.6704                         1
    ------------ ----------------------------- ---------------- ------------------------------------ ------------------------------ ---
    30           q_right_shoulder_roll_joint   JointPos         -2.2515                              1.5882                         1 
    ------------ ----------------------------- ---------------- ------------------------------------ ------------------------------ ---
    31           q_right_shoulder_yaw_joint    JointPos         -2.618                               2.618                          1 
    ------------ ----------------------------- ---------------- ------------------------------------ ------------------------------ ---
    32           q_right_elbow_joint           JointPos         -1.0472                              2.0944                         1 
    ------------ ----------------------------- ---------------- ------------------------------------ ------------------------------ ---
    33           q_right_wrist_roll_joint      JointPos         -1.97222                             1.97222                        1 
    ------------ ----------------------------- ---------------- ------------------------------------ ------------------------------ ---
    34           q_right_wrist_pitch_joint     JointPos         -1.61443                             1.61443                        1
    ------------ ----------------------------- ---------------- ------------------------------------ ------------------------------ ---
    35           q_right_wrist_yaw_joint       JointPos         -1.61443                             1.61443                        1 
    ------------ ----------------------------- ---------------- ------------------------------------ ------------------------------ ---
    36 - 42      q_ball_joint                  FreeJointPosXY   [-inf, -inf, -inf, -inf, -inf]       [inf, inf, inf, inf, inf]      7
    ============ ============================= ================ ==================================== ============================== ===
    ...
    ------------ ----------------------------- ---------------- ------------------------------------ ------------------------------ ---
    22           q_right_shoulder_pitch_joint  JointPos         -3.0892                              2.6704                         1
    ------------ ----------------------------- ---------------- ------------------------------------ ------------------------------ ---
    23           q_right_shoulder_roll_joint   JointPos         -2.2515                              1.5882                         1 
    ------------ ----------------------------- ---------------- ------------------------------------ ------------------------------ ---
    24           q_right_shoulder_yaw_joint    JointPos         -2.618                               2.618                          1 
    ------------ ----------------------------- ---------------- ------------------------------------ ------------------------------ ---
    25           q_right_elbow_joint           JointPos         -1.0472                              2.0944                         1 
    ------------ ----------------------------- ---------------- ------------------------------------ ------------------------------ ---
    26           q_right_wrist_roll_joint      JointPos         -1.97222                             1.97222                        1 
    ------------ ----------------------------- ---------------- ------------------------------------ ------------------------------ ---
    27           q_right_wrist_pitch_joint     JointPos         -1.61443                             1.61443                        1
    ------------ ----------------------------- ---------------- ------------------------------------ ------------------------------ ---
    28           q_right_wrist_yaw_joint       JointPos         -1.61443                             1.61443                        1 
    ============ ============================= ================ ==================================== ============================== ===
    ...
    def get_default_xml_file_path(cls) -> str:
        ...
        """
        xml_file = "robot_models/scene_g1_29_ball.xml"
